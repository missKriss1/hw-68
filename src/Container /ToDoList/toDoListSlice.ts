...
export const fetchTodoList = createAsyncThunk('toDoList/fetchTodoList', async () => {
...
export const fetchToDoListPost = createAsyncThunk('toDoList/fetchToDoListPost', async (title: string) => {
  const response = await axiosApi.post<ToDoList>(`toDoList.json`, {title, status:false});
